/* eslint-disable */
// Generated by Wrangler by running `wrangler types` (hash: 5dc92034f8c01a72085ea23cfda7b74a)
// Runtime types generated with workerd@1.20260826.1 2026-08-28 nodejs_compat
interface __BaseEnv_Env {
	MEDIA: R2Bucket;
	DB: D1Database;
	PERFORMANCE: AnalyticsEngineDataset;
	PRODUCT_ANALYTICS: AnalyticsEngineDataset;
	IMAGES: ImagesBinding;
	STREAM: StreamBinding;
	ENVIRONMENT: "production";
	ALLOWED_ORIGINS: "https://sdui-reddit-api.patjackson52.workers.dev,http://localhost:8080,http://127.0.0.1:8080,http://10.0.2.2:8787";
	VIDEO_TRANSCODING: "stream";
	IMAGE_DELIVERY: "images";
	IMAGES_ACCOUNT_HASH: "yT3z-3N1UU2O7d5VHFxwIA";
	AUTH_PEPPER: string;
	ANALYTICS_ID_PEPPER: string;
	CURSOR_SECRET: string;
	MEDIA_SIGNING_SECRET: string;
	IMAGES_SIGNING_KEY: string;
	POST_ROOMS: DurableObjectNamespace<import("./src/index").PostRoom>;
	RATE_LIMITERS: DurableObjectNamespace<import("./src/index").RateLimiter>;
}
declare namespace Cloudflare {
	interface GlobalProps {
		mainModule: typeof import("./src/index");
		durableNamespaces: "PostRoom" | "RateLimiter";
	}
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "ENVIRONMENT" | "ALLOWED_ORIGINS" | "VIDEO_TRANSCODING" | "IMAGE_DELIVERY" | "IMAGES_ACCOUNT_HASH" | "AUTH_PEPPER" | "ANALYTICS_ID_PEPPER" | "CURSOR_SECRET" | "MEDIA_SIGNING_SECRET" | "IMAGES_SIGNING_KEY">> {}
}
