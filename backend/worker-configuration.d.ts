/* eslint-disable */
// Generated by Wrangler by running `wrangler types` (hash: c80c5ed4abd722706201e5dfc989372a)
...
interface __BaseEnv_Env {
	...
	ALLOWED_ORIGINS: "http://localhost:8080,http://10.0.2.2:8787";
	VIDEO_TRANSCODING: "stream";
	IMAGE_DELIVERY: "images";
	IMAGES_ACCOUNT_HASH: "REPLACE_WITH_CLOUDFLARE_IMAGES_ACCOUNT_HASH";
	AUTH_PEPPER: string;
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "ENVIRONMENT" | "ALLOWED_ORIGINS" | "VIDEO_TRANSCODING" | "IMAGE_DELIVERY" | "IMAGES_ACCOUNT_HASH" | "AUTH_PEPPER" | "CURSOR_SECRET" | "MEDIA_SIGNING_SECRET">> {}
}
