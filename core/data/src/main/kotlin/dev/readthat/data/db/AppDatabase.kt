...
abstract class AppDatabase : RoomDatabase() {
    ...
    companion object {
        private const val NAME = "readthat.db"
        ...
        val MIGRATION_3_4 = object : Migration(3, 4) {
            override fun migrate(db: SupportSQLiteDatabase) {
                ...
                db.execSQL("DROP TABLE feed_groups")
                db.execSQL("ALTER TABLE feed_groups_new RENAME TO feed_groups")
                ...
                db.execSQL("DROP TABLE item_state")
                db.execSQL("ALTER TABLE item_state_new RENAME TO item_state")
                ...
                db.execSQL("DROP TABLE vote_outbox")
                db.execSQL("ALTER TABLE vote_outbox_new RENAME TO vote_outbox")
        ...
        val MIGRATION_4_5 = object : Migration(4, 5) {
            override fun migrate(db: SupportSQLiteDatabase) {
                ...
                db.execSQL("CREATE INDEX IF NOT EXISTS index_post_outbox_accountId ON post_outbox(accountId)")
            }
        }
        ...
        val MIGRATION_7_8 = object : Migration(7, 8) {
            override fun migrate(db: SupportSQLiteDatabase) {
                ...
                db.execSQL("DROP TABLE feed_positions_v8")
                db.execSQL(
                    """
        ...
        val MIGRATION_13_14 = object : Migration(13, 14) {
            override fun migrate(db: SupportSQLiteDatabase) {
                db.execSQL("ALTER TABLE subreddits ADD COLUMN avatarUrl TEXT")
                db.execSQL("ALTER TABLE subreddits ADD COLUMN rulesJson TEXT NOT NULL DEFAULT '[]'")
                db.execSQL(
                    """
        ...
        val MIGRATION_16_17 = object : Migration(16, 17) {
            override fun migrate(db: SupportSQLiteDatabase) {
                db.execSQL("ALTER TABLE post_outbox ADD COLUMN flairId TEXT")
                db.execSQL("ALTER TABLE post_outbox ADD COLUMN flairText TEXT")
                db.execSQL("ALTER TABLE post_outbox ADD COLUMN flairBackgroundColor TEXT")
                db.execSQL("ALTER TABLE post_outbox ADD COLUMN flairTextColor TEXT")
            }
        }
        ...
        fun get(context: Context): AppDatabase = instance ?: synchronized(this) {
            instance ?: Room.databaseBuilder(
                ...
                // Only the pre-outbox development schema may be recreated.
                // Never destructively migrate versions that can contain writes.
